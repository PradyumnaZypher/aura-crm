...
import {
  Sparkles, Target, Phone, MessageSquare, Megaphone,
  HeadphonesIcon, FolderOpen, LogOut, Bell, Search, LayoutDashboard,
} from "lucide-react"
import {
      ...
      <Sidebar collapsible="icon">
        ...
        <SidebarFooter className="p-3">
          <div className="flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-sidebar-accent transition-colors cursor-pointer">
            ...
            <Button variant="ghost" size="icon-sm" onClick={() => router.push("/login")}>
